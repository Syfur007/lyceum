...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE posts SET post_title = :post_title, post_description = :post_description, category_id = :category_id, modified_at = NOW() 
    ...
    if ($stmt->execute()) {
        echo "<script>console.log('Post updated successfully!');</script>";
